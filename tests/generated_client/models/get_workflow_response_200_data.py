...
class GetWorkflowResponse200Data:
    ...
    id: int
    label: str
    out_schema: GetWorkflowResponse200DataOutSchemaType0 | None
    pack: int
    pack_ref: str
    param_schema: GetWorkflowResponse200DataParamSchemaType0 | None
    ref: str
    tags: list[str]
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.out_schema, GetWorkflowResponse200DataOutSchemaType0):
        ...
        if isinstance(self.param_schema, GetWorkflowResponse200DataParamSchemaType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_out_schema(data: object) -> GetWorkflowResponse200DataOutSchemaType0 | None:
            ...
            try:
                ...
                pass
            return cast(GetWorkflowResponse200DataOutSchemaType0 | None, data)
        ...
        def _parse_param_schema(data: object) -> GetWorkflowResponse200DataParamSchemaType0 | None:
            ...
            try:
                ...
                pass
            return cast(GetWorkflowResponse200DataParamSchemaType0 | None, data)
