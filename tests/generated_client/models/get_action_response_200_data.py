...
if TYPE_CHECKING:
  from ..models.get_action_response_200_data_out_schema_type_0 import GetActionResponse200DataOutSchemaType0
  from ..models.get_action_response_200_data_param_schema_type_0 import GetActionResponse200DataParamSchemaType0
  from ..models.get_action_response_200_data_required_worker_runtimes import GetActionResponse200DataRequiredWorkerRuntimes
  from ..models.get_action_response_200_data_worker_selector import GetActionResponse200DataWorkerSelector
...
class GetActionResponse200Data:
    ...
    required_worker_runtimes: GetActionResponse200DataRequiredWorkerRuntimes | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_out_schema(data: object) -> GetActionResponse200DataOutSchemaType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                out_schema_type_0 = GetActionResponse200DataOutSchemaType0.from_dict(data)
        ...
        def _parse_param_schema(data: object) -> GetActionResponse200DataParamSchemaType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                param_schema_type_0 = GetActionResponse200DataParamSchemaType0.from_dict(data)
        ...
        if isinstance(_required_worker_runtimes,  Unset):
            ...
            required_worker_runtimes = GetActionResponse200DataRequiredWorkerRuntimes.from_dict(_required_worker_runtimes)
        ...
        if isinstance(_worker_selector,  Unset):
            ...
            worker_selector = GetActionResponse200DataWorkerSelector.from_dict(_worker_selector)
