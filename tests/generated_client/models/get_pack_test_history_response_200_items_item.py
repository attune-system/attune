...
@_attrs_define
class GetPackTestHistoryResponse200ItemsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_pack_test_history_response_200_items_item = cls(
            created=created,
        ...
        get_pack_test_history_response_200_items_item.additional_properties = d
        return get_pack_test_history_response_200_items_item
