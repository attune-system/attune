...
class WorkQueueItemResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_error, WorkQueueItemResponseLastErrorType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_ack_summary(data: object) -> None | WorkQueueItemResponseAckSummaryType0:
            ...
            try:
                ...
                pass
            return cast(None | WorkQueueItemResponseAckSummaryType0, data)
        ...
        def _parse_last_error(data: object) -> None | WorkQueueItemResponseLastErrorType0:
            ...
            try:
                ...
                pass
            return cast(None | WorkQueueItemResponseLastErrorType0, data)
