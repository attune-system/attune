...
if TYPE_CHECKING:
  from ..models.cancel_execution_response_200_data_config import CancelExecutionResponse200DataConfig
  from ..models.cancel_execution_response_200_data_result import CancelExecutionResponse200DataResult
  from ..models.cancel_execution_response_200_data_worker_affinity_type_0 import CancelExecutionResponse200DataWorkerAffinityType0
  from ..models.cancel_execution_response_200_data_worker_selector_type_0 import CancelExecutionResponse200DataWorkerSelectorType0
  from ..models.cancel_execution_response_200_data_worker_tolerations_type_0_item import CancelExecutionResponse200DataWorkerTolerationsType0Item
  from ..models.cancel_execution_response_200_data_workflow_task_type_0 import CancelExecutionResponse200DataWorkflowTaskType0





T = TypeVar("T", bound="CancelExecutionResponse200Data")



@_attrs_define
class CancelExecutionResponse200Data:
    """ Response DTO for execution information

        Attributes:
            action_ref (str): Action reference Example: slack.post_message.
            config (CancelExecutionResponse200DataConfig): Execution configuration/parameters
            created (datetime.datetime): Creation timestamp Example: 2024-01-13T10:30:00Z.
            id (int): Execution ID Example: 1.
            result (CancelExecutionResponse200DataResult): Execution result/output
            ...
            worker_selector (CancelExecutionResponse200DataWorkerSelectorType0 | None | Unset): Worker selector override
                stored on the execution, if any.
            worker_tolerations (list[CancelExecutionResponse200DataWorkerTolerationsType0Item] | None | Unset): Worker
                tolerations override stored on the execution, if any.
            workflow_task (CancelExecutionResponse200DataWorkflowTaskType0 | None | Unset): Workflow task metadata (only
                populated for workflow task executions)
     """

    action_ref: str
    config: CancelExecutionResponse200DataConfig
    created: datetime.datetime
    id: int
    result: CancelExecutionResponse200DataResult
    status: ExecutionStatus
    ...
    worker_affinity: CancelExecutionResponse200DataWorkerAffinityType0 | None | Unset = UNSET
    worker_selector: CancelExecutionResponse200DataWorkerSelectorType0 | None | Unset = UNSET
    worker_tolerations: list[CancelExecutionResponse200DataWorkerTolerationsType0Item] | None | Unset = UNSET
    workflow_task: CancelExecutionResponse200DataWorkflowTaskType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.worker_affinity, CancelExecutionResponse200DataWorkerAffinityType0):
        ...
        elif isinstance(self.worker_selector, CancelExecutionResponse200DataWorkerSelectorType0):
        ...
        if isinstance(self.workflow_task, Unset):
            workflow_task = UNSET
        elif isinstance(self.workflow_task, CancelExecutionResponse200DataWorkflowTaskType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config = CancelExecutionResponse200DataConfig.from_dict(d.pop("config"))
        ...
        result = CancelExecutionResponse200DataResult.from_dict(d.pop("result"))
        ...
        def _parse_worker_affinity(data: object) -> CancelExecutionResponse200DataWorkerAffinityType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                worker_affinity_type_0 = CancelExecutionResponse200DataWorkerAffinityType0.from_dict(data)
                ...
                pass
            return cast(CancelExecutionResponse200DataWorkerAffinityType0 | None | Unset, data)

        worker_affinity = _parse_worker_affinity(d.pop("worker_affinity", UNSET))


        def _parse_worker_selector(data: object) -> CancelExecutionResponse200DataWorkerSelectorType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                worker_selector_type_0 = CancelExecutionResponse200DataWorkerSelectorType0.from_dict(data)
                ...
                pass
            return cast(CancelExecutionResponse200DataWorkerSelectorType0 | None | Unset, data)

        worker_selector = _parse_worker_selector(d.pop("worker_selector", UNSET))


        def _parse_worker_tolerations(data: object) -> list[CancelExecutionResponse200DataWorkerTolerationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for worker_tolerations_type_0_item_data in (_worker_tolerations_type_0):
                    worker_tolerations_type_0_item = CancelExecutionResponse200DataWorkerTolerationsType0Item.from_dict(worker_tolerations_type_0_item_data)
                ...
                pass
            return cast(list[CancelExecutionResponse200DataWorkerTolerationsType0Item] | None | Unset, data)

        worker_tolerations = _parse_worker_tolerations(d.pop("worker_tolerations", UNSET))


        def _parse_workflow_task(data: object) -> CancelExecutionResponse200DataWorkflowTaskType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workflow_task_type_0 = CancelExecutionResponse200DataWorkflowTaskType0.from_dict(data)
                ...
                pass
            return cast(CancelExecutionResponse200DataWorkflowTaskType0 | None | Unset, data)

        workflow_task = _parse_workflow_task(d.pop("workflow_task", UNSET))


        cancel_execution_response_200_data = cls(
            action_ref=action_ref,
            config=config,
            created=created,
            id=id,
        ...
        cancel_execution_response_200_data.additional_properties = d
        return cancel_execution_response_200_data
