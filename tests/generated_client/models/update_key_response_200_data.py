...
T = TypeVar("T", bound="UpdateKeyResponse200Data")



@_attrs_define
class UpdateKeyResponse200Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_key_response_200_data = cls(
            created=created,
            encrypted=encrypted,
            id=id,
            name=name,
        ...
        update_key_response_200_data.additional_properties = d
        return update_key_response_200_data
