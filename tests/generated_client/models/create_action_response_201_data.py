...
if TYPE_CHECKING:
  ...
  from ..models.create_action_response_201_data_required_worker_runtimes import CreateActionResponse201DataRequiredWorkerRuntimes
  from ..models.create_action_response_201_data_worker_selector import CreateActionResponse201DataWorkerSelector
...
class CreateActionResponse201Data:
    ...
    required_worker_runtimes: CreateActionResponse201DataRequiredWorkerRuntimes | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        required_worker_runtimes: CreateActionResponse201DataRequiredWorkerRuntimes | Unset
        if isinstance(_required_worker_runtimes,  Unset):
            required_worker_runtimes = UNSET
        else:
            required_worker_runtimes = CreateActionResponse201DataRequiredWorkerRuntimes.from_dict(_required_worker_runtimes)
        ...
        if isinstance(_worker_selector,  Unset):
            ...
            worker_selector = CreateActionResponse201DataWorkerSelector.from_dict(_worker_selector)
