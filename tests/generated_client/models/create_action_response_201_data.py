...
if TYPE_CHECKING:
    from ..models.create_action_response_201_data_out_schema_type_0 import (
        CreateActionResponse201DataOutSchemaType0,
    )
    from ..models.create_action_response_201_data_param_schema_type_0 import (
        CreateActionResponse201DataParamSchemaType0,
    )
    from ..models.create_action_response_201_data_required_worker_runtimes import (
        CreateActionResponse201DataRequiredWorkerRuntimes,
    )
    from ..models.create_action_response_201_data_worker_selector import (
...
class CreateActionResponse201Data:
    ...
    Attributes:
        ...
        is_adhoc (bool): Whether this is an ad-hoc action (not from pack installation) Example: False.
        ...
        param_schema (CreateActionResponse201DataParamSchemaType0 | None): Parameter schema (StackStorm-style with
        ...
        required_worker_runtimes (CreateActionResponse201DataRequiredWorkerRuntimes | Unset): Additional worker runtime
        ...
        worker_selector (CreateActionResponse201DataWorkerSelector | Unset): Exact worker label requirements.
    ...
    required_worker_runtimes: (
        CreateActionResponse201DataRequiredWorkerRuntimes | Unset
    ) = UNSET
    ...
    worker_selector: CreateActionResponse201DataWorkerSelector | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_out_schema(
            data: object,
        ) -> CreateActionResponse201DataOutSchemaType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                out_schema_type_0 = CreateActionResponse201DataOutSchemaType0.from_dict(
                    data
                )
        ...
        def _parse_param_schema(
            data: object,
        ) -> CreateActionResponse201DataParamSchemaType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                param_schema_type_0 = (
                    CreateActionResponse201DataParamSchemaType0.from_dict(data)
                )
        ...
        if isinstance(_required_worker_runtimes, Unset):
            ...
            required_worker_runtimes = (
                CreateActionResponse201DataRequiredWorkerRuntimes.from_dict(
        ...
        worker_selector: CreateActionResponse201DataWorkerSelector | Unset
        if isinstance(_worker_selector, Unset):
            worker_selector = UNSET
        else:
            worker_selector = CreateActionResponse201DataWorkerSelector.from_dict(
                _worker_selector
            )
