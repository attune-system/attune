...
if TYPE_CHECKING:
  from ..models.api_response_audit_event_response_data_correlation_chain_type_0 import ApiResponseAuditEventResponseDataCorrelationChainType0
  from ..models.api_response_audit_event_response_data_details_type_0 import ApiResponseAuditEventResponseDataDetailsType0





T = TypeVar("T", bound="ApiResponseAuditEventResponseData")



@_attrs_define
class ApiResponseAuditEventResponseData:
    """ Full audit event with all fields.

        Attributes:
            category (str): High-level category. Example: auth.
            correlation_chain (ApiResponseAuditEventResponseDataCorrelationChainType0 | None): Optional cascade chain
                (rule_id, enforcement_id, execution_id, …).
            created (datetime.datetime): Event creation timestamp. Example: 2024-01-13T10:30:00Z.
            details (ApiResponseAuditEventResponseDataDetailsType0 | None): Event-specific structured metadata. Secrets are
                redacted.
    ...
    category: str
    correlation_chain: ApiResponseAuditEventResponseDataCorrelationChainType0 | None
    created: datetime.datetime
    details: ApiResponseAuditEventResponseDataDetailsType0 | None
    event_type: str
    id: int
    outcome: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.correlation_chain, ApiResponseAuditEventResponseDataCorrelationChainType0):
        ...
        if isinstance(self.details, ApiResponseAuditEventResponseDataDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_correlation_chain(data: object) -> ApiResponseAuditEventResponseDataCorrelationChainType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                correlation_chain_type_0 = ApiResponseAuditEventResponseDataCorrelationChainType0.from_dict(data)
                ...
                pass
            return cast(ApiResponseAuditEventResponseDataCorrelationChainType0 | None, data)
        ...
        def _parse_details(data: object) -> ApiResponseAuditEventResponseDataDetailsType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                details_type_0 = ApiResponseAuditEventResponseDataDetailsType0.from_dict(data)
                ...
                pass
            return cast(ApiResponseAuditEventResponseDataDetailsType0 | None, data)
        ...
        api_response_audit_event_response_data = cls(
            category=category,
            correlation_chain=correlation_chain,
            created=created,
            details=details,
        ...
        api_response_audit_event_response_data.additional_properties = d
        return api_response_audit_event_response_data
