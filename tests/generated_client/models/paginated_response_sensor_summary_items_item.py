...
T = TypeVar("T", bound="PaginatedResponseSensorSummaryItemsItem")



@_attrs_define
class PaginatedResponseSensorSummaryItemsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_sensor_summary_items_item = cls(
            created=created,
            enabled=enabled,
            id=id,
            label=label,
        ...
        paginated_response_sensor_summary_items_item.additional_properties = d
        return paginated_response_sensor_summary_items_item
