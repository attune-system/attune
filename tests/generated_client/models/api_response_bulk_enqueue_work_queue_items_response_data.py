...
T = TypeVar("T", bound="ApiResponseBulkEnqueueWorkQueueItemsResponseData")


@_attrs_define
class ApiResponseBulkEnqueueWorkQueueItemsResponseData:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        api_response_bulk_enqueue_work_queue_items_response_data = cls(
            created_count=created_count,
            items=items,
            updated_count=updated_count,
        )

        api_response_bulk_enqueue_work_queue_items_response_data.additional_properties = d
        return api_response_bulk_enqueue_work_queue_items_response_data
