...
if TYPE_CHECKING:
  from ..models.permission_set_role_assignment_response import PermissionSetRoleAssignmentResponse





T = TypeVar("T", bound="UpdatePermissionSetResponse200Data")



@_attrs_define
class UpdatePermissionSetResponse200Data:
    """ 
        Attributes:
            grants (Any):
            id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_permission_set_response_200_data.additional_properties = d
        return update_permission_set_response_200_data
