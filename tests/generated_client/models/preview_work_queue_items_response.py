...
T = TypeVar("T", bound="PreviewWorkQueueItemsResponse")



@_attrs_define
class PreviewWorkQueueItemsResponse:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        preview_work_queue_items_response = cls(
            items=items,
            matched_count=matched_count,
            preview_count=preview_count,
        )
        ...
        preview_work_queue_items_response.additional_properties = d
        return preview_work_queue_items_response
