...
T = TypeVar("T", bound="GetCurrentUserResponse200Data")


@_attrs_define
class GetCurrentUserResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_current_user_response_200_data = cls(
            assigned_permission_set_refs=assigned_permission_set_refs,
            auth_provider=auth_provider,
            can_change_password=can_change_password,
            effective_permissions=effective_permissions,
        ...
        get_current_user_response_200_data.additional_properties = d
        return get_current_user_response_200_data
