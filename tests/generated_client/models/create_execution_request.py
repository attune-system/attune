...
if TYPE_CHECKING:
  ...
  from ..models.create_execution_request_parameters import CreateExecutionRequestParameters
  from ..models.create_execution_request_worker_affinity_type_0 import CreateExecutionRequestWorkerAffinityType0
  from ..models.create_execution_request_worker_selector_type_0 import CreateExecutionRequestWorkerSelectorType0
  from ..models.create_execution_request_worker_tolerations_type_0_item import CreateExecutionRequestWorkerTolerationsType0Item
...
class CreateExecutionRequest:
    ...
    worker_tolerations: list[CreateExecutionRequestWorkerTolerationsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.worker_affinity, CreateExecutionRequestWorkerAffinityType0):
        ...
        elif isinstance(self.worker_selector, CreateExecutionRequestWorkerSelectorType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_worker_affinity(data: object) -> CreateExecutionRequestWorkerAffinityType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                worker_affinity_type_0 = CreateExecutionRequestWorkerAffinityType0.from_dict(data)
        ...
        def _parse_worker_selector(data: object) -> CreateExecutionRequestWorkerSelectorType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                worker_selector_type_0 = CreateExecutionRequestWorkerSelectorType0.from_dict(data)
        ...
        def _parse_worker_tolerations(data: object) -> list[CreateExecutionRequestWorkerTolerationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for worker_tolerations_type_0_item_data in (_worker_tolerations_type_0):
                    worker_tolerations_type_0_item = CreateExecutionRequestWorkerTolerationsType0Item.from_dict(worker_tolerations_type_0_item_data)
                ...
                pass
            return cast(list[CreateExecutionRequestWorkerTolerationsType0Item] | None | Unset, data)
