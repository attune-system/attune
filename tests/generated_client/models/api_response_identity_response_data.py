...
T = TypeVar("T", bound="ApiResponseIdentityResponseData")


@_attrs_define
class ApiResponseIdentityResponseData:
    """
    Attributes:
        attributes (Any):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.permission_assignment_response import (
        ...
        api_response_identity_response_data = cls(
            attributes=attributes,
            direct_permissions=direct_permissions,
            frozen=frozen,
            id=id,
        ...
        api_response_identity_response_data.additional_properties = d
        return api_response_identity_response_data
