...
if TYPE_CHECKING:
  from ..models.apply_work_queue_items_request_payload_patch_type_0 import ApplyWorkQueueItemsRequestPayloadPatchType0
...
class ApplyWorkQueueItemsRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_payload_patch(data: object) -> ApplyWorkQueueItemsRequestPayloadPatchType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                payload_patch_type_0 = ApplyWorkQueueItemsRequestPayloadPatchType0.from_dict(data)
