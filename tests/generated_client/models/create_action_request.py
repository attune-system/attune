...
if TYPE_CHECKING:
  ...
  from ..models.create_action_request_worker_selector import CreateActionRequestWorkerSelector
...
class CreateActionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_worker_selector,  Unset):
            ...
            worker_selector = CreateActionRequestWorkerSelector.from_dict(_worker_selector)
