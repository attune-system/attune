...
class CreateWorkflowResponse201Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        definition = CreateWorkflowResponse201DataDefinition.from_dict(d.pop("definition"))
        ...
        def _parse_out_schema(data: object) -> CreateWorkflowResponse201DataOutSchemaType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                out_schema_type_0 = CreateWorkflowResponse201DataOutSchemaType0.from_dict(data)
        ...
        def _parse_param_schema(data: object) -> CreateWorkflowResponse201DataParamSchemaType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                param_schema_type_0 = CreateWorkflowResponse201DataParamSchemaType0.from_dict(data)
