...
T = TypeVar("T", bound="RescheduleExecutionResponse200Data")



@_attrs_define
class RescheduleExecutionResponse200Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reschedule_execution_response_200_data = cls(
            attempt_count=attempt_count,
            execution=execution,
            last_attempt_at=last_attempt_at,
            message=message,
        ...
        reschedule_execution_response_200_data.additional_properties = d
        return reschedule_execution_response_200_data
