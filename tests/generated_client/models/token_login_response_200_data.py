...
T = TypeVar("T", bound="TokenLoginResponse200Data")



@_attrs_define
class TokenLoginResponse200Data:
    """ Token response
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        token_login_response_200_data = cls(
            access_token=access_token,
            expires_in=expires_in,
            refresh_token=refresh_token,
            token_type=token_type,
        ...
        token_login_response_200_data.additional_properties = d
        return token_login_response_200_data
