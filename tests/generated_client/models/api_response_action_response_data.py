...
if TYPE_CHECKING:
  ...
  from ..models.api_response_action_response_data_required_worker_runtimes import ApiResponseActionResponseDataRequiredWorkerRuntimes
  from ..models.api_response_action_response_data_worker_selector import ApiResponseActionResponseDataWorkerSelector
...
class ApiResponseActionResponseData:
    ...
    required_worker_runtimes: ApiResponseActionResponseDataRequiredWorkerRuntimes | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        required_worker_runtimes: ApiResponseActionResponseDataRequiredWorkerRuntimes | Unset
        if isinstance(_required_worker_runtimes,  Unset):
            required_worker_runtimes = UNSET
        else:
            required_worker_runtimes = ApiResponseActionResponseDataRequiredWorkerRuntimes.from_dict(_required_worker_runtimes)
        ...
        if isinstance(_worker_selector,  Unset):
            ...
            worker_selector = ApiResponseActionResponseDataWorkerSelector.from_dict(_worker_selector)
