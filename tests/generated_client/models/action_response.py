...
if TYPE_CHECKING:
    ...
    from ..models.action_response_param_schema_type_0 import (
        ActionResponseParamSchemaType0,
    )
    from ..models.action_response_required_worker_runtimes import (
        ActionResponseRequiredWorkerRuntimes,
    )
    from ..models.action_response_worker_selector import ActionResponseWorkerSelector
...
class ActionResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.action_response_out_schema_type_0 import (
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        from ..models.action_response_worker_selector import (
        ...
        if isinstance(_required_worker_runtimes, Unset):
            ...
            required_worker_runtimes = ActionResponseRequiredWorkerRuntimes.from_dict(
        ...
        worker_selector: ActionResponseWorkerSelector | Unset
        if isinstance(_worker_selector, Unset):
            worker_selector = UNSET
        else:
            worker_selector = ActionResponseWorkerSelector.from_dict(_worker_selector)
