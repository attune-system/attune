...
if TYPE_CHECKING:
  ...
  from ..models.action_response_required_worker_runtimes import ActionResponseRequiredWorkerRuntimes
...
class ActionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_required_worker_runtimes,  Unset):
            ...
            required_worker_runtimes = ActionResponseRequiredWorkerRuntimes.from_dict(_required_worker_runtimes)
