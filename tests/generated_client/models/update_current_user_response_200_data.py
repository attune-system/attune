...
T = TypeVar("T", bound="UpdateCurrentUserResponse200Data")


@_attrs_define
class UpdateCurrentUserResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_current_user_response_200_data = cls(
            assigned_permission_set_refs=assigned_permission_set_refs,
            auth_provider=auth_provider,
            can_change_password=can_change_password,
            effective_permissions=effective_permissions,
        ...
        update_current_user_response_200_data.additional_properties = d
        return update_current_user_response_200_data
