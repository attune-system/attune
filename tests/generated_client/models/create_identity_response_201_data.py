...
T = TypeVar("T", bound="CreateIdentityResponse201Data")


@_attrs_define
class CreateIdentityResponse201Data:
    """
    Attributes:
        attributes (Any):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_identity_response_201_data = cls(
            attributes=attributes,
            direct_permissions=direct_permissions,
            frozen=frozen,
            id=id,
        ...
        create_identity_response_201_data.additional_properties = d
        return create_identity_response_201_data
