...
T = TypeVar("T", bound="ApiResponsePolicyResponseData")


@_attrs_define
class ApiResponsePolicyResponseData:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.concurrency_policy_response import (
            ConcurrencyPolicyResponse,
        )
        from ..models.rate_limit_policy_response import (
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        return api_response_policy_response_data
