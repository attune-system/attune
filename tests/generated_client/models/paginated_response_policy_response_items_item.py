...
T = TypeVar("T", bound="PaginatedResponsePolicyResponseItemsItem")


@_attrs_define
class PaginatedResponsePolicyResponseItemsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_policy_response_items_item = cls(
            created=created,
            id=id,
            method=method,
            name=name,
        ...
        paginated_response_policy_response_items_item.additional_properties = d
        return paginated_response_policy_response_items_item
