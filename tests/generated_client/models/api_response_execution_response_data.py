...
if TYPE_CHECKING:
  ...
  from ..models.api_response_execution_response_data_worker_affinity_type_0 import ApiResponseExecutionResponseDataWorkerAffinityType0
  from ..models.api_response_execution_response_data_worker_selector_type_0 import ApiResponseExecutionResponseDataWorkerSelectorType0
  from ..models.api_response_execution_response_data_worker_tolerations_type_0_item import ApiResponseExecutionResponseDataWorkerTolerationsType0Item
...
class ApiResponseExecutionResponseData:
    ...
    worker_affinity: ApiResponseExecutionResponseDataWorkerAffinityType0 | None | Unset = UNSET
    worker_selector: ApiResponseExecutionResponseDataWorkerSelectorType0 | None | Unset = UNSET
    worker_tolerations: list[ApiResponseExecutionResponseDataWorkerTolerationsType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.worker_affinity, ApiResponseExecutionResponseDataWorkerAffinityType0):
        ...
        elif isinstance(self.worker_selector, ApiResponseExecutionResponseDataWorkerSelectorType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_worker_affinity(data: object) -> ApiResponseExecutionResponseDataWorkerAffinityType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                worker_affinity_type_0 = ApiResponseExecutionResponseDataWorkerAffinityType0.from_dict(data)
                ...
                pass
            return cast(ApiResponseExecutionResponseDataWorkerAffinityType0 | None | Unset, data)

        worker_affinity = _parse_worker_affinity(d.pop("worker_affinity", UNSET))


        def _parse_worker_selector(data: object) -> ApiResponseExecutionResponseDataWorkerSelectorType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                worker_selector_type_0 = ApiResponseExecutionResponseDataWorkerSelectorType0.from_dict(data)
                ...
                pass
            return cast(ApiResponseExecutionResponseDataWorkerSelectorType0 | None | Unset, data)

        worker_selector = _parse_worker_selector(d.pop("worker_selector", UNSET))


        def _parse_worker_tolerations(data: object) -> list[ApiResponseExecutionResponseDataWorkerTolerationsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for worker_tolerations_type_0_item_data in (_worker_tolerations_type_0):
                    worker_tolerations_type_0_item = ApiResponseExecutionResponseDataWorkerTolerationsType0Item.from_dict(worker_tolerations_type_0_item_data)
                ...
                pass
            return cast(list[ApiResponseExecutionResponseDataWorkerTolerationsType0Item] | None | Unset, data)
