...
if TYPE_CHECKING:
  ...
  from ..models.update_action_response_200_data_worker_selector import UpdateActionResponse200DataWorkerSelector
...
class UpdateActionResponse200Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_worker_selector,  Unset):
            ...
            worker_selector = UpdateActionResponse200DataWorkerSelector.from_dict(_worker_selector)
