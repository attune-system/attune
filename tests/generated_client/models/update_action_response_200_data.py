...
if TYPE_CHECKING:
    from ..models.update_action_response_200_data_out_schema_type_0 import (
        UpdateActionResponse200DataOutSchemaType0,
    )
    from ..models.update_action_response_200_data_param_schema_type_0 import (
        UpdateActionResponse200DataParamSchemaType0,
    )
    from ..models.update_action_response_200_data_required_worker_runtimes import (
        UpdateActionResponse200DataRequiredWorkerRuntimes,
    )
    from ..models.update_action_response_200_data_worker_selector import (
...
class UpdateActionResponse200Data:
    ...
    Attributes:
        ...
        worker_selector (UpdateActionResponse200DataWorkerSelector | Unset): Exact worker label requirements.
    ...
    required_worker_runtimes: (
        UpdateActionResponse200DataRequiredWorkerRuntimes | Unset
    ) = UNSET
    ...
    worker_selector: UpdateActionResponse200DataWorkerSelector | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_out_schema(
            data: object,
        ) -> None | UpdateActionResponse200DataOutSchemaType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                out_schema_type_0 = UpdateActionResponse200DataOutSchemaType0.from_dict(
                    data
                )
        ...
        def _parse_param_schema(
            data: object,
        ) -> None | UpdateActionResponse200DataParamSchemaType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                param_schema_type_0 = (
                    UpdateActionResponse200DataParamSchemaType0.from_dict(data)
                )
        ...
        if isinstance(_required_worker_runtimes, Unset):
            ...
            required_worker_runtimes = (
                UpdateActionResponse200DataRequiredWorkerRuntimes.from_dict(
        ...
        worker_selector: UpdateActionResponse200DataWorkerSelector | Unset
        if isinstance(_worker_selector, Unset):
            worker_selector = UNSET
        else:
            worker_selector = UpdateActionResponse200DataWorkerSelector.from_dict(
                _worker_selector
            )
