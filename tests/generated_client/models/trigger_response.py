...
if TYPE_CHECKING:
  from ..models.trigger_response_out_schema_type_0 import TriggerResponseOutSchemaType0
  from ..models.trigger_response_param_schema_type_0 import TriggerResponseParamSchemaType0
