...
T = TypeVar("T", bound="GetQueueStatsResponse200Data")



@_attrs_define
class GetQueueStatsResponse200Data:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_queue_stats_response_200_data = cls(
            action_id=action_id,
            action_ref=action_ref,
            active_count=active_count,
            last_updated=last_updated,
        ...
        get_queue_stats_response_200_data.additional_properties = d
        return get_queue_stats_response_200_data
