...
if TYPE_CHECKING:
  ...
  from ..models.update_action_request_worker_selector_type_0 import UpdateActionRequestWorkerSelectorType0
...
class UpdateActionRequest:
    ...
    required_worker_runtimes: None | Unset | UpdateActionRequestRequiredWorkerRuntimesType0 = UNSET
    ...
    timeout_seconds: None | TimeoutSecondsPatchType0 | TimeoutSecondsPatchType1 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.required_worker_runtimes, UpdateActionRequestRequiredWorkerRuntimesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_default_execution_permission_set_refs(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        default_execution_permission_set_refs = _parse_default_execution_permission_set_refs(d.pop("default_execution_permission_set_refs", UNSET))
        ...
        def _parse_out_schema(data: object) -> None | Unset | UpdateActionRequestOutSchemaType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_param_schema(data: object) -> None | Unset | UpdateActionRequestParamSchemaType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_required_worker_runtimes(data: object) -> None | Unset | UpdateActionRequestRequiredWorkerRuntimesType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | Unset | UpdateActionRequestRequiredWorkerRuntimesType0, data)

        required_worker_runtimes = _parse_required_worker_runtimes(d.pop("required_worker_runtimes", UNSET))
        ...
        def _parse_timeout_seconds(data: object) -> None | TimeoutSecondsPatchType0 | TimeoutSecondsPatchType1 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_timeout_seconds_patch_type_0 = TimeoutSecondsPatchType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_timeout_seconds_patch_type_1 = TimeoutSecondsPatchType1.from_dict(data)
                ...
                pass
            return cast(None | TimeoutSecondsPatchType0 | TimeoutSecondsPatchType1 | Unset, data)
        ...
        def _parse_worker_selector(data: object) -> None | Unset | UpdateActionRequestWorkerSelectorType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                worker_selector_type_0 = UpdateActionRequestWorkerSelectorType0.from_dict(data)
