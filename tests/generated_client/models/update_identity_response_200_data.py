...
T = TypeVar("T", bound="UpdateIdentityResponse200Data")


@_attrs_define
class UpdateIdentityResponse200Data:
    """
    Attributes:
        attributes (Any):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_identity_response_200_data = cls(
            attributes=attributes,
            direct_permissions=direct_permissions,
            frozen=frozen,
            id=id,
        ...
        update_identity_response_200_data.additional_properties = d
        return update_identity_response_200_data
