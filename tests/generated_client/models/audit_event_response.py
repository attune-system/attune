...
class AuditEventResponse:
    ...
    details: AuditEventResponseDetailsType0 | None
    event_type: str
    id: int
    outcome: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.correlation_chain, AuditEventResponseCorrelationChainType0):
        ...
        if isinstance(self.details, AuditEventResponseDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_correlation_chain(data: object) -> AuditEventResponseCorrelationChainType0 | None:
            ...
            try:
                ...
                pass
            return cast(AuditEventResponseCorrelationChainType0 | None, data)
