...
T = TypeVar("T", bound="WorkerSummary")
...
class WorkerSummary:
    """
    Attributes:
        cordoned (bool):  Example: False.
        created (datetime.datetime):  Example: 2026-04-11T13:26:37Z.
        health_state (WorkerHealthState):
        heartbeat_stale (bool):  Example: False.
        id (int):  Example: 1.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        from ..models.worker_load_snapshot import WorkerLoadSnapshot
        from ..models.worker_runtime_support import (
        ...
        worker_summary.additional_properties = d
