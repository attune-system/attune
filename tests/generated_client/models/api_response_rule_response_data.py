...
if TYPE_CHECKING:
    from ..models.api_response_rule_response_data_action_params import (
...
class ApiResponseRuleResponseData:
    ...
    Attributes:
        ...
        is_adhoc (bool): Whether this is an ad-hoc rule (not from pack installation) Example: False.
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        action_params = ApiResponseRuleResponseDataActionParams.from_dict(
            d.pop("action_params")
        )

        action_ref = d.pop("action_ref")

        conditions = ApiResponseRuleResponseDataConditions.from_dict(
            d.pop("conditions")
        )
