...
T = TypeVar("T", bound="ApiResponseRegisterPacksResponseData")


@_attrs_define
class ApiResponseRegisterPacksResponseData:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        api_response_register_packs_response_data = cls(
            failed_packs=failed_packs,
            registered_packs=registered_packs,
            summary=summary,
        )

        api_response_register_packs_response_data.additional_properties = d
        return api_response_register_packs_response_data
