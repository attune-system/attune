...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/cache/namespaces/{namespace}/generations/{generation_id}/abandon".format(namespace=quote(str(namespace), safe=""),generation_id=quote(str(generation_id), safe=""),),
    }
